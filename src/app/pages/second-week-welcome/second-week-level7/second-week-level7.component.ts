...
@Component({
  selector: 'app-second-week-level7',
  templateUrl: './second-week-level7.component.html',
  styleUrls: ['./second-week-level7.component.css']
})
export class SecondWeekLevel7Component implements OnInit {
  showStrengths = false;
