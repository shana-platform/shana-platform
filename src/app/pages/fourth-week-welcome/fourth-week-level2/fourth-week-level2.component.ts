...
@Component({
  selector: 'app-fourth-week-level2',
  templateUrl: './fourth-week-level2.component.html',
  styleUrls: ['./fourth-week-level2.component.css']
})
export class FourthWeekLevel2Component implements OnInit {
  slides = [
    {
