...
@Component({
  selector: 'app-third-week-level7',
  templateUrl: './third-week-level7.component.html',
  styleUrls: ['./third-week-level7.component.css']
})
export class ThirdWeekLevel7Component implements OnInit {
  showStrengths = false;
